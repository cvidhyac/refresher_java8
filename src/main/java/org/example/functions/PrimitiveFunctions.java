...
public class PrimitiveFunctions {
    ...
    static IntConsumer printPrimeResponse = num -> System.out.println("The number is divisible By 3, received " + num);
    static IntConsumer printEvenResponse = num -> System.out.println("The number is divisible by 2, received " + num);
